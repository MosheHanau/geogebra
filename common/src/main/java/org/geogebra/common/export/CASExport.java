...
public class CASExport {
	...
	private String translateMapleCommand(Command command,
		...
		case "NextPrime":
			def = MapleCommandTranslator.translateNextPrime(command,
					argument -> translateMapleArgument(argument, fullNameToShortName));
			break;

		case "Product":
			def = MapleCommandTranslator.translateProduct(command,
					argument -> translateMapleArgument(argument, fullNameToShortName));
			break;
		...
		case "Sum":
			def = MapleCommandTranslator.translateSum(command,
					argument -> translateMapleArgument(argument, fullNameToShortName));
			break;
